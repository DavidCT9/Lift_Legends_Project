...
export default function Avatar(props) {
  ...
  const { actions } = useAnimations(offensiveIdle, group);

  useEffect(() => {
    if (actions && actions["offensiveIdle"]) {
      actions["offensiveIdle"].reset().play();
      console.log(actions["offensiveIdle"]); // Check if the action exists
